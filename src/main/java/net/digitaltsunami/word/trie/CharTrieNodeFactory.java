...
public interface CharTrieNodeFactory {
    ...
    /**
     * Create a new root node. The node must respond true to
     * {@link CharTrieNode#isRoot}.
     * 
     ...
     */
    public CharTrieTerminusNode addChildTerminus(CharTrieNode parentNode, char value);
     ...
     *         applicable values set.
     */
    public CharTrieTerminusNode addChildTerminus(CharTrieNode parentNode, char value, String term);
