...
public class DamerauLevenshteinDistanceStrategyTest {
    private static DamerauLevenshteinDistanceStrategy distanceCalculator;

    @BeforeClass
    public static void initEditCounter() {
        distanceCalculator = new DamerauLevenshteinDistanceStrategy();
    }
    ...
    /**
     * Test that the edit distance is 1 when the two adjacent characters are
     * transposed within the strings.
     */
    @Test
    public void testEditDistanceTranspose() {
        assertEquals(1, distanceCalculator.getEditDistance("abcde", "abdce"), 0.01);
        assertEquals(1, distanceCalculator.getEditDistance("abcdef", "bacdef"), 0.01);
        assertEquals(1, distanceCalculator.getEditDistance("abcdef", "abdcef"), 0.01);
        assertEquals(1, distanceCalculator.getEditDistance("abcdef", "abcdfe"), 0.01);
        assertEquals(1, distanceCalculator.getEditDistance("bacdef", "abcdef"), 0.01);
        assertEquals(1, distanceCalculator.getEditDistance("abdcef", "abcdef"), 0.01);
        assertEquals(1, distanceCalculator.getEditDistance("abcdfe", "abcdef"), 0.01);
    }
    /**
     * Test that the edit distance is calculated correctly when the adjacent
     * characters are the same.
     */
    @Test
    public void testEditDistanceChars() {
        assertEquals(2.0, distanceCalculator.getEditDistance("aaa", "a"), 0.01);
        assertEquals(1.0, distanceCalculator.getEditDistance("aaa", "aa"), 0.01);
        assertEquals(0.0, distanceCalculator.getEditDistance("aaa", "aaa"), 0.01);
        assertEquals(1.0, distanceCalculator.getEditDistance("aaa", "aaaa"), 0.01);
        assertEquals(2.0, distanceCalculator.getEditDistance("aaa", "aaaaa"), 0.01);
    }

    /**
     * Test that the edit count is the full length of the string when compared
     * to an empty string.
     */
    @Test
    ...
    /**
     * Test that the edit count is correct when a mix of edits (delete, insert,
     * update) are applied.
     */
    @Test
    ...
    /**
     * Test that the edit count is 1 when the strings differ by one character.
     * Test that the substitution is recognized from either string and in
     * various places.
     */
    @Test
    ...
    /**
     * Test that the edit count is 1 when the two adjacent characters are
     * transposed within the strings.
     */
    @Test
    public void testEditCountTranspose() {
        assertEquals(1, distanceCalculator.getEditCount("abcde", "abdce"));
        assertEquals(1, distanceCalculator.getEditCount("abcdef", "bacdef"));
        assertEquals(1, distanceCalculator.getEditCount("abcdef", "abdcef"));
        assertEquals(1, distanceCalculator.getEditCount("abcdef", "abcdfe"));
        assertEquals(1, distanceCalculator.getEditCount("bacdef", "abcdef"));
        assertEquals(1, distanceCalculator.getEditCount("abdcef", "abcdef"));
        assertEquals(1, distanceCalculator.getEditCount("abcdfe", "abcdef"));
    }

    /**
     * Test that the edit count is calculated correctly when the adjacent
     * characters are the same.
     */
    @Test
    public void testEditCountSameChars() {
        assertEquals(2, distanceCalculator.getEditCount("aaa", "a"));
        assertEquals(1, distanceCalculator.getEditCount("aaa", "aa"));
        assertEquals(0, distanceCalculator.getEditCount("aaa", "aaa"));
        assertEquals(1, distanceCalculator.getEditCount("aaa", "aaaa"));
        assertEquals(2, distanceCalculator.getEditCount("aaa", "aaaaa"));
    }
}
