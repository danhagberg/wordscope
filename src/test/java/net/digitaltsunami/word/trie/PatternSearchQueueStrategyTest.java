...
/**
 * Test pattern variations return proper matches when using queue strategy.
 * @author dhagberg
 *
 */
public class PatternSearchQueueStrategyTest {
    private final PatternSearchStrategy strategy = new PatternSearchQueueStrategy();
